...
screen about():
    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            if gui.about:
                text "[gui.about!t]\n"
            text "Created by BSEMC-DAT Students at Bukidnon State University \n          Iszabela Caszandra N. Cardona\n          Gabrielle Revecho\n          Blessy J. Yacapin\n"
            text "Instructor: Mark Daniel G. Dacer and Rov Japheth G. Oracion\n\nSubject: Intro to Game Design & Development and Data Structures and Algorithms S.Y. 2025-2026\n\n"
