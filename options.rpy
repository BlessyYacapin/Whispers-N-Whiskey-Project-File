...
define config.name = _("Whispers n' Whiskey")
...
define build.name = "Whispers_n_Whiskey_Demo"
...
define config.window_show_transition = Dissolve(.01)
define config.window_hide_transition = Dissolve(.01)
...
define config.save_directory = "WhispersnWhiskeytrial2-1761615654"
...
init python:
    ...
    #MOVIES
    build.classify('game/**.mp4', 'movies')
    build.classify('game/**.webm', 'movies')
    build.classify('game/**.mov', 'movies')
...
define build.itch_project = "CodeBERRY/whispers-n-whiskey"
